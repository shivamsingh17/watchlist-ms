...
//        WatchlistResponse watchlistResponse = watchlistRepository.findMovie(userId, movieId);
        ...
        MovieResponse movieResponse = webClient.get()
                ...
                .header(HttpHeaders.AUTHORIZATION, "Bearer movie-service6cda51ffd6384878af98797672977a0f")
                .retrieve()
                .bodyToMono(MovieResponse.class).block();
        System.out.println(movieResponse.getMovie_name());
        System.out.println(movieResponse.getGenre());
        return null;
